...
import { ArrowLeft, MoveLeft, OctagonXIcon } from "lucide-react"
...
export default function ExerciseEditForm() {
        ...
        <>
            <div className="min-h-screen overflow-x-hidden antialiased text-white overscroll-none">
                <div className="absolute top-1/4 md:top-[37%] left-0 md:left-[1.5%] lg:left-[5%] xl:left-1/5 bg-gray-900 border border-gray-800 shadow-2xl rounded-2xl p-20 md:py-20 md:px-[calc(10rem_-_(5rem_/_2))]">
                    ...
                    <div className="max-sm:pt-10 md:relative top-[90%] left-1/2">
                        <Link href="." className="inline-flex items-center gap-2 hover:text-amber-500">
    ...
    async function onSubmit(values: z.infer<typeof editFormSchema>) {
        ...
        if ('defaultErr' in res) {
            toast.warning(res.defaultErr)
        } else {
            // TODO: Add other error handling here especially for validation
            createSonnerCookie({
                type: 'statusCode' in res ? 'err' : 'success',
                msg: 'statusCode' in res ? res.message as string : res.updated
            })
